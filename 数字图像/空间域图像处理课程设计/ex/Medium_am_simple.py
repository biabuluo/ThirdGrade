...
def mediumfilter_am_simple(img_arr, max_win):
    # 中值滤波器：
...
if __name__ == '__main__':
    ...
    img_arr_medium = mediumfilter_am_simple(img_arr, 9)
    img_medium = Image2arr.arr2image(img_arr_medium)
    img_medium.save("./result_simple/c+saltpeper1+medi.bmp")

    img, name = ShowImage.get_img("./img_noise/", 'c+saltpeper3')
    img_arr = Image2arr.image2arr(img)
    img_arr_medium = mediumfilter_am_simple(img_arr, 9)
    img_medium = Image2arr.arr2image(img_arr_medium)
    img_medium.save("./result_simple/c+saltpeper3+medi.bmp")

    img, name = ShowImage.get_img("./img_noise/", 'c+saltpeper5')
    img_arr = Image2arr.image2arr(img)
    img_arr_medium = mediumfilter_am_simple(img_arr, 9)
    img_medium = Image2arr.arr2image(img_arr_medium)
    img_medium.save("./result_simple/c+saltpeper5+medi.bmp")

    img, name = ShowImage.get_img("./img_noise/", 'c+gaussian')
    img_arr = Image2arr.image2arr(img)
    img_arr_medium = mediumfilter_am_simple(img_arr, 9)
    img_medium = Image2arr.arr2image(img_arr_medium)
    img_medium.save("./result_simple/c+gaussian+medi.bmp")
